...
<div className=" bg-bb ">
  <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
    <div className="flex flex-col justify-around sm:px-[18px] md:flex-row md:px-10">
    <div className="md:w-[316px] mr-10 flex flex-col items-center">
  <img 
    src={logo} // Replace with the actual path to your logo image
    alt="Company Logo" 
    className="h-[90px] w-auto mb-2" // Adjust height as needed
  />
  <p className="mt-[18px] text-[15px] font-normal text-black text-center">
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, fugit non. Incidunt dolorum adipisci, 
    tempore asperiores nemo odio facere officiis enim animi placeat eaque nesciunt alias beatae id, 
    at dicta.
  </p>
</div>

<div className="md:w-[316px] mx-auto flex flex-col items-center justify-center">
        <div className="mt-[23px] flex">
          ...
          <div className="ml-[18px]">
            <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium text-black">+91 1800123444</a>
            <p className="font-Inter text-[12px] font-medium text-black">Support Number</p>
          </div>
        </div>
        <div className="mt-[23px] flex">
          <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
          ...
          <div className="ml-[18px]">
            <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-black">help@lorem.com</a>
            <p className="font-Inter text-[12px] font-medium text-black">Support Email</p>
          </div>
        </div>
        <div className="mt-[23px] flex">
          <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
          ...
          <div className="ml-[18px]">
            <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-black">Sub Nerul, Mumbia,
              India, 123456</a>
            <p className="font-Inter text-[12px] font-medium text-black">Address</p>
          </div>
        </div>
      </div>
      <div className="mt-6 flex w-full ml-10 flex-col justify-between text-black sm:flex-row md:mt-0 md:max-w-[341px]">
        <div className="">
          <p className="text-black font-inter text-[18px] font-medium leading-normal">Pages</p>
          <ul>
            ...
            <li className="mt-[15px]"><a
                className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/our-tutors">Appointment</a></li>
            <li className="mt-[15px]"><a
                className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/become-a-tutor">Records</a></li>
            <li className="mt-[15px]"><a
                className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/plans-and-pricing">Billing</a></li>
            <li className="mt-[15px]"><a
                className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/terms-and-conditions">Reports</a></li>
